...
def open_databases(ctx):
    ctx.obj['data'] = {
        'source': source_database(ctx.obj['config']['data']['source'], ctx.obj['secret']),
        'download': download_database(ctx.obj['config']['data']['download'], ctx.obj['secret']),
        'bangumi_moe': bangumi_moe_database(ctx.obj['config']['data']['bangumi_moe'], ctx.obj['secret'])
    }
